...
class TablesControllerTest < ActionController::TestCase
  ...
  test "should create table" do
    assert_difference('Table.count') do
      post :create, table: { UserID: @table.UserID, fes_id: @table.fes_id, seedNumber: @table.seedNumber, teamName: @table.teamName, teamNumber: @table.teamNumber }
    end
  ...
  test "should update table" do
    patch :update, id: @table, table: { UserID: @table.UserID, fes_id: @table.fes_id, seedNumber: @table.seedNumber, teamName: @table.teamName, teamNumber: @table.teamNumber }
    assert_redirected_to table_path(assigns(:table))
  end
