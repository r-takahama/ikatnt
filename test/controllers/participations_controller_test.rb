...
class ParticipationsControllerTest < ActionController::TestCase
  ...
  test "should create participation" do
    assert_difference('Participation.count') do
      post :create, participation: { NNID: @participation.NNID, TwitterID: @participation.TwitterID, UserID: @participation.UserID, teamName: @participation.teamName }
    end
  ...
  test "should update participation" do
    patch :update, id: @participation, participation: { NNID: @participation.NNID, TwitterID: @participation.TwitterID, UserID: @participation.UserID, teamName: @participation.teamName }
    assert_redirected_to participation_path(assigns(:participation))
  end
