...
#### K01_1.トップページ
 ...
 4. 大会ID入力済みの状態で「大会管理画面」ボタン押下によって「K03_1.大会トップページ」に遷移(IDなし及び数字じゃなければエラー)
 5. コンタクトの表示(遷移なし) 
...
#### K02_1.大会新規登録画面
 ...
 3. 大会概要を登録(自由テキスト)(任意)
 4. 大会ルールを選択(トーナメント、リーグ戦、スイスドローの3つからプルダウンで選択し、決勝トーナメント参加数を8、16からプルダウンで選択)(選択されていなければエラー)
 ...
 7. 参加登録締め切り日時を登録(プルダウン)(初期値は5と同じ日時)
 8. 運営コミュニティを登録(任意)
...
#### K03_1.大会トップページ
 ...
 2. 「運営者管理メニュー」ボタン押下によって「K03_2.運営者管理画面」に遷移
 2. 「トーナメント表ダウンロード」ボタン押下によってPDFダウンロード(登録締め切り日時以降)
 3. 「参加登録」ボタン押下によって「K04_1.参加登録画面」に遷移
 4. 「参加者メニュー」ボタン押下によって「04_3.参加者ログイン画面」に遷移
